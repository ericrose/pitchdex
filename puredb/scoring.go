...
const (
	OverallBullshit = "Overall Bullshit Score"
)

var ReviewScoreNames []string
var AuthorScoreNames []string

func init() {
	for name, _ := range IndexDefinitions {
		ReviewScoreNames = append(ReviewScoreNames, name)
	}
	AuthorScoreNames = append(ReviewScoreNames, OverallBullshit)
}
